...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    page.should_be_success_message(page.get_product_title())
    page.should_be_price_message(page.get_product_price())
...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        ...
        login_page.register_new_user(str(time())+"@email.org", "j4sBt2Salr%who4")
